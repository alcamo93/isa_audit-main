...
class DashabordAuditCustomer
{
  ...
  {
    $completeProjects = ProcessAudit::getProcessKpiWithSpecificSectionToEvaluate('audit', $this->currentYear, $this->idCustomer)->get();
    ...
    foreach ($projects as $project) {
      $instance = new DashabordAudit($project->current_audit_register->id_audit_register);
