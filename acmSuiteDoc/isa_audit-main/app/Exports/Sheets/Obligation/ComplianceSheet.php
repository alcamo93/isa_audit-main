...
class ComplianceSheet implements FromView, WithTitle, WithDrawings, WithStyles
{
	use Exportable;
	...
	{
		return view('exports.obligation.compliance', [
			'data' => $this->data
		]);
	}
	...
	{
		return 'Cumplimiento Permisos Críticos';
	}
	...
	public function styles(Worksheet $sheet)
	{
		...
		// underlined title
		$sheet->getStyle('D2:M2')->applyFromArray($styleArray);
