...
namespace App\Exports\Dashboard\ComplianceGlobal;

use Maatwebsite\Excel\Concerns\Exportable;
use Maatwebsite\Excel\Concerns\WithMultipleSheets;
use App\Exports\Dashboard\ComplianceGlobal\Sheets\SheetOne;
use App\Exports\Dashboard\ComplianceGlobal\Sheets\SheetTwo;
use App\Exports\Dashboard\ComplianceGlobal\Sheets\SheetThree;
use App\Exports\Dashboard\ComplianceGlobal\Sheets\SheetFour;
use App\Exports\Dashboard\ComplianceGlobal\Sheets\SheetFive;
use App\Exports\Dashboard\ComplianceGlobal\Sheets\SheetSix;
use App\Exports\Dashboard\ComplianceGlobal\Sheets\SheetSeven;

class ComplianceGlobalExcel implements WithMultipleSheets
{
	use Exportable;
