...
class SheetOne implements FromView, WithTitle, WithDrawings, WithStyles
{
	...
	{
		return view('exports.dashboard.auditGlobal.sheets.sheetOne', [
			'data' => $this->data
		]);
	}
    ...
    $sheet->getStyle('B4:E6')->applyFromArray(Style::STYLE_BORDER_MAIN)->applyFromArray(Style::STYLE_CARD_HEADERS);
    ...
    // historical header
    $sheet->getStyle('B26:V27')->applyFromArray(Style::STYLE_TITLE_DOCUMENT)->applyFromArray(Style::STYLE_BORDER_MAIN);
    $sheet->getStyle('B29:I45')->applyFromArray(Style::STYLE_BORDER_MAIN);
    $sheet->getStyle('K29:V45')->applyFromArray(Style::STYLE_BORDER_MAIN);
	}
}
