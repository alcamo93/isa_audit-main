...
namespace App\Exports\Dashboard\ObligationCorporate;

use Maatwebsite\Excel\Concerns\Exportable;
use Maatwebsite\Excel\Concerns\WithMultipleSheets;
use App\Exports\Dashboard\ObligationCorporate\Sheets\SheetOne;
use App\Exports\Dashboard\ObligationCorporate\Sheets\SheetTwo;
use App\Exports\Dashboard\ObligationCorporate\Sheets\SheetThree;
use App\Exports\Dashboard\ObligationCorporate\Sheets\SheetFour;
use App\Exports\Dashboard\ObligationCorporate\Sheets\SheetFive;
use App\Exports\Dashboard\ObligationCorporate\Sheets\SheetSix;
use App\Exports\Dashboard\ObligationCorporate\Sheets\SheetSeven;
use App\Exports\Dashboard\ObligationCorporate\Sheets\SheetEight;
use App\Exports\Dashboard\ObligationCorporate\Sheets\SheetNine;
use App\Exports\Dashboard\ObligationCorporate\Sheets\SheetTen;
use App\Exports\Dashboard\ObligationCorporate\Sheets\SheetEleven;

class ObligationCorporateExcel implements WithMultipleSheets
{
	use Exportable;
