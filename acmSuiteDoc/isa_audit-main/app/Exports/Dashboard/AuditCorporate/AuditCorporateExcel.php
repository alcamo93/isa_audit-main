...
namespace App\Exports\Dashboard\AuditCorporate;

use Maatwebsite\Excel\Concerns\Exportable;
use Maatwebsite\Excel\Concerns\WithMultipleSheets;
use App\Exports\Dashboard\AuditCorporate\Sheets\SheetOne;
use App\Exports\Dashboard\AuditCorporate\Sheets\SheetTwo;
use App\Exports\Dashboard\AuditCorporate\Sheets\SheetThree;
use App\Exports\Dashboard\AuditCorporate\Sheets\SheetFour;
use App\Exports\Dashboard\AuditCorporate\Sheets\SheetFive;
use App\Exports\Dashboard\AuditCorporate\Sheets\SheetSix;

class AuditCorporateExcel implements WithMultipleSheets
{
	use Exportable;
