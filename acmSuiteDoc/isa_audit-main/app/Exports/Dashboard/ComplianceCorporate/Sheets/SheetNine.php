...
class SheetNine implements FromView, WithTitle, WithDrawings, WithStyles, WithColumnWidths
{
	use Exportable;
	...
	{
		return view('exports.dashboard.complianceCorporate.sheets.sheetNine', [
			'data' => $this->data
		]);
	}
