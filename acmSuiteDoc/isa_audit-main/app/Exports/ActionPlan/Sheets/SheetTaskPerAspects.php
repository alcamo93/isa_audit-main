...
class SheetTaskPerAspects implements FromView, WithTitle, WithDrawings, WithStyles, WithColumnWidths
{
	use Exportable;
	...
	{
		return view('exports.action.plan.sheets.sheetTaskPerAspects', [
			'data' => $this->data
		]);
	}
    ...
    $sheet->getRowDimension(2)->setRowHeight(70);
		...
		$sheet->getStyle('B2:M3')->applyFromArray(Style::STYLE_TITLE_DOCUMENT)->applyFromArray(Style::STYLE_BORDER_MAIN);
    // logo
