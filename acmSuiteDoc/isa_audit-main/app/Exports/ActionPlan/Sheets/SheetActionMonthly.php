...
class SheetActionMonthly implements FromView, WithTitle, WithDrawings, WithStyles, WithColumnWidths
{
	use Exportable;
	...
	{
		return view('exports.action.plan.sheets.sheetActionMonthly', [
			'data' => $this->data
		]);
	}
