...
class SheetActionPerAspects implements FromView, WithTitle, WithDrawings, WithStyles, WithColumnWidths
{
	use Exportable;
	...
	{
		return view('exports.action.plan.sheets.sheetActionPerAspects', [
			'data' => $this->data
		]);
	}
