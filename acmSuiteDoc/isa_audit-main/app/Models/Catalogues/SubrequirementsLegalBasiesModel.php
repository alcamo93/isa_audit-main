...
class SubrequirementsLegalBasiesModel extends Model
{
    protected $table = 'r_subrequirements_legal_basies';
    protected $primaryKey = 'id_subrequirement_lb';
    /**
     * Get legal basis
     */
    public function scopeGetBasiesBySubrequirement($query, $idSubrequirement){
        $query->join('t_legal_basises', 't_legal_basises.id_legal_basis', 'r_subrequirements_legal_basies.id_legal_basis')
            ...
            ->where('r_subrequirements_legal_basies.id_subrequirement', $idSubrequirement);
     ...
     */
    public function scopeGetBasisBySubrequirementDT($query, $info) {
        $query->join('t_legal_basises', 'r_subrequirements_legal_basies.id_legal_basis', 't_legal_basises.id_legal_basis')
            ->join('t_guidelines', 't_guidelines.id_guideline', 't_legal_basises.id_guideline')
        ...
        $where = [];
        array_push($where, ['r_subrequirements_legal_basies.id_subrequirement', $info['id']]);
