...
class SpecificRequirementLegalController extends Controller
{
   ...
   */
  public function guideline($idRequirement) {
    try {
   ...
   */
  public function articles($idRequirement) {
    try {
   ...
   */
  public function relation($idRequirement, $idLegalBasis) 
  {
    try {
