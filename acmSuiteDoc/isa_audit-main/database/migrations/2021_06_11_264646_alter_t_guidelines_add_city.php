...
class AlterTGuidelinesAddCity extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('t_guidelines', function (Blueprint $table) {
            $table->unsignedBigInteger('id_city')->nullable()->after('id_state')->comment('Foreign key referring to audit processes table');
        });
