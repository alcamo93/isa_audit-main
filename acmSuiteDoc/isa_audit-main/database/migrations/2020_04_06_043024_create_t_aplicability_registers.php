...
class CreateTAplicabilityRegisters extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('t_aplicability_registers', function (Blueprint $table) {
            $table->bigIncrements('id_aplicability_register');
    ...
    {
        Schema::dropIfExists('t_aplicability_registers');
    }
}
