...
class AlterTObligationsAddAuditProcess extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('t_obligations', function (Blueprint $table) {
            $table->unsignedBigInteger('id_audit_processes')->nullable()->comment('Reference to audit process')->after('id_action_register');
        });
