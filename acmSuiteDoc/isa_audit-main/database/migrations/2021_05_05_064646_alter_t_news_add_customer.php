...
class AlterTNewsAddCustomer extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('t_news', function (Blueprint $table) {
            $table->unsignedBigInteger('id_customer')->nullable()->after('id_status')->comment('Foreign key referring to customer table');
            $table->unsignedBigInteger('id_corporate')->nullable()->after('id_status')->comment('Foreign key referring to corporate table');
