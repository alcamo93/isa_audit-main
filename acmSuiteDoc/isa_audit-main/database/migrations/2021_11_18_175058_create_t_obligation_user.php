...
class CreateTObligationUser extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('t_obligation_user', function (Blueprint $table) {
            $table->bigIncrements('id_obligation_user');
            ...
            $table->unsignedBigInteger('id_obligation')->comment('Foreign key referring to action table');
            $table->timestamps();
        });
        Schema::table('t_obligation_user', function($table) {
    ...
    {
        Schema::dropIfExists('t_obligation_user');
    }
}
