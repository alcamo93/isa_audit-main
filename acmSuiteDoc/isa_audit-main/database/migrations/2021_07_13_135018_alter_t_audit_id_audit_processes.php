...
class AlterTAuditIdAuditProcesses extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('t_audit', function (Blueprint $table) {
            $table->unsignedBigInteger('id_audit_processes')->nullable()->after('finding')->comment('Foreign key referring to audit processes table');
        });
