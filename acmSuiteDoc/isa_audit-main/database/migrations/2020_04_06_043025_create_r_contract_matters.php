...
class CreateRContractMatters extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('r_contract_matters', function (Blueprint $table) {
            $table->bigIncrements('id_contract_matter');
            ...
            $table->unsignedBigInteger('id_aplicability_register')->comment('Foreign key referring to aplicability registers table');
    ...
    {
        Schema::dropIfExists('r_contract_matters');
    }
}
