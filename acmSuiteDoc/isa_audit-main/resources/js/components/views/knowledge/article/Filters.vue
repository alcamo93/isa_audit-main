  ...
  <div class="mb-2">
    ...
    <b-row>
      <b-col sm="12" md="6">
        ...
        <b-form-input v-model="filters.legal_basis" placeholder="Búsqueda por Artículo" debounce="500"></b-form-input>
      </b-col>
      <b-col sm="12" md="6">
        <label>Cita Legal</label>
        <b-form-input v-model="filters.legal_quote" placeholder="Búsqueda por Cita Legal" debounce="500"></b-form-input>
      </b-col>
    </b-row>
  </div>
</template>
