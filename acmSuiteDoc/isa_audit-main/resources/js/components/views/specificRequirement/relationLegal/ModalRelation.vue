...
import ModalLegalQuote from '../../catalogs/guideline/legal_basi/ModalLegalQuote.vue'
import Filters from './Filters.vue'
import { getRelationArticles, setRelationLegal } from '../../../../services/specificRequirementLegalsService'
  ...
  methods: {
    ...
    async getArticles() {
      try {
        ...
        const { data } = await getRelationArticles(this.record.id_requirement, params, this.filters)
    ...
    async setLegal({id_legal_basis}) {
      try {
        this.showLoadingMixin()
        const { data } = await setRelationLegal(this.record.id_requirement, id_legal_basis)
        await this.getArticles()
        this.showLoadingMixin()
      } catch (error) {
        this.showLoadingMixin()
