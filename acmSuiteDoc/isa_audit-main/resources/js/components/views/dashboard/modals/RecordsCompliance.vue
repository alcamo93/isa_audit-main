...
import { getRecordsDashboardCompliance } from '../../../../services/dashboardService'
  ...
  methods: {
    ...
    async getRecords() {
      try {
        ...
        const { data } = await getRecordsDashboardCompliance(this.idAuditProcess, this.idAplicabilityRegister, this.idAuditRegister, params, this.filters)
