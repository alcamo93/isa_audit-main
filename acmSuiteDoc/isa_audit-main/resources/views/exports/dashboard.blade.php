...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <th colspan="4" style="font-family:sans-serif; font-size: 12px; color:#a6a6a6;">
        ...
        <tr >
            <th colspan="3"></th>
            <th colspan="4" style="font-family:sans-serif; font-size: 20px; color:#003e52;">Cumplimiento Global</th>
            <th colspan="2" style="font-family:sans-serif; font-size: 20px; color:#ff5000;">{{ $data['audit_global'] }}%</th>
            <th colspan="4"></th>
            <th colspan="4" style="font-family:sans-serif; font-size: 20px; color:#003e52;">Hallazgos Totales</th>
            <th colspan="2" style="font-family:sans-serif; font-size: 20px; color:#f7323f;">{{ $data['count_global'] }}</th>
            <th colspan="5"></th>
        </tr>
        <tr >
            <th colspan="24"></th>
        ...
        <tr >
            <th colspan="2"></th>
            <th colspan="5"  style="font-family:sans-serif; font-size: 16px; color:#a6a6a6;" >Detalle de Cumplimiento</th>
            <th colspan="6"></th>
            <th colspan="5"  style="font-family:sans-serif; font-size: 16px; color:#a6a6a6;" >Detalle de Hallazgos</th>
            <th colspan="6"></th>
        </tr>
        <tr >
            <th colspan="24"></th>
        ...
        <tr >
            <th colspan="2"></th>
            <th colspan="2"></th>
            <th colspan="4" style="font-family:sans-serif; font-size: 16px; color:#a6a6a6;">{{ $m['matter'] }}</th>
            <th colspan="2" style="font-family:sans-serif; font-size: 16px; color:{{ $m['color'] }};">{{ $m['total'] }}%</th>
            <th colspan="3"></th>
            <th colspan="2"></th>
            <th colspan="4" style="font-family:sans-serif; font-size: 16px; color:#a6a6a6;">{{ $m['matter'] }}</th>
            <th colspan="2" style="font-family:sans-serif; font-size: 16px; color:{{ $m['color'] }};">{{ $m['count'] }}</th>
            <th colspan="2"></th>
        </tr>
        <tr >
            <th colspan="24"></th>
