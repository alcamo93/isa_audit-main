<div id="editModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" id="editModalIntro">
        <div class="modal-content">
            ...
            <form class="form" id="updateProcessesForm">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="u-processes" name="u-processes" type="text" class="form-control"  
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <select id="u-idScope" name="u-idScope" class="form-control"
                                    onchange="showField(this.value, '#u-specification')"
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12 d-none specificationDepartament">
                            <div class="form-group">
                                ...
                                <input id="u-specification" name="u-specification" type="text" class="form-control" placeholder="Nombre del departamento" 
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <select id="u-idLeader" name="u-idLeader" class="form-control"
                                    onchange="getAuditors(this.value, '#u-auditors', true)"
                                    title="Selecciona una opción" required>
                                    <option value=""></option>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <select id="u-auditors" name="u-auditors" class="selectpicker form-control" data-width="100px" 
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group">
                                ...
                                <!-- data-size="auto" data-container="modal-body" -->
                                <select id="u-aspects" name="u-aspects" class="selectpicker form-control" data-width="100px" 
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="form-check align-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" id="u-risk" type="checkbox"/>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="btnEdit" class="btn btn-primary float-right">Actualizar</button>
                </div>      
            </form>      
        </div>
    </div>
